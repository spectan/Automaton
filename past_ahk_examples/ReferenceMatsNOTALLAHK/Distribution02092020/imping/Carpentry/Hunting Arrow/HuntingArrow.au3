#cs ==================================================================================================
	...
	H  U  N  T  I  N  G    A  R  R  O  W    I  M  P  E  R
	call me robin hood
	~ Dissimulo scripts
	...
	Version History
	-0.1 (Bare Bones)
	--Ported over from needle imperrr
...
#cs
	...
	- [3] huntingarrowicontext.bmp
	- [4] logicon.bmp ;toolbelt slot 1
	- [5] knifeicon.bmp ;toolbelt slot 2
...
Func AnchorSet()
	Sleep(100)
	FindImage('huntingarrowicontext.bmp', 0, 0, 0, @DesktopWidth, @DesktopHeight, $anchorXY, 3)
	If $imagefound[3] == 1 Then
		...
		Next
	Else
		MsgBox(0, "Debug Msgbox", "huntingarrowicontext.bmp not found, exiting", 0, $handle) ;Debug
        Sleep(100)
        _Exit()
	EndIf
	FindImage('huntingarrowicontext.bmp', 1, 0, 0, @DesktopWidth, @DesktopHeight, $anchorXY, 3)
	If $imagefound[3] == 1 Then
		For $n = 0 to $actions - 1
			...
			If $stamina == 1 Then
				;MsgBox(0, "Debug Msgbox", "Stamina Found", 0, $handle) ;Debug
				 ...
				 For $m = 0 To $actions - 1
					 ...
					 Else
						 FindImage('knifeicon.bmp', 1, $anchorimprove[0], $anchor[$m][1], $anchorimprove[1], $anchor[$m][1]+ 17, $a, 5)
