 #include <Misc.au3>
   ...
   HotKeySet("{v}", "bsb")
	...
	Func bsb()
	  ...
	  EndFunc
	    ...
	    Func Heads()
       MsgBox(0, "", "Where handles will be")
       $head=1
    EndFunc
   ...
   If IsArray($line) Then
              ...
              Sleep($random2-33)
              MouseMove($line[0]+125, $line[1]+56, 0)
			  sleep($random2-14)
			  MouseMove($line[0]+225, $line[1]+56, 0)
			  sleep($random2+41)
			MouseMove($line[0]+225, $line[1]+128, 0)
			  sleep($random2+41)
              MouseClick("left")
          Sleep($random2)
   EndIf
       ...
       if $running==1 Then
		  ...
		  Local $random = Random(11000, 12000, 1)
		   ...
		   Sleep(3000)
			  ...
			  MouseDown("left")
			  Sleep(50)
			   MouseMove($bsbloc[0], $bsbloc[1], 23)
			   MouseUp("left")
			   Sleep(500)
