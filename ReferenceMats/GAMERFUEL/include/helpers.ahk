...
doSingleSmithImp()
{
global improve, repair, actions, smithToolbelt
loop %actions% 
    {
    findRow()
        if (!findRow())
        ...
        doKey(repair)
        randSleep()
        doKey(carpentryToolbelt["lump"])
        randSleep()
        doKey(improve)
        randSleep(1000, 2000)
        }
        else if (findImpItem("hammer"))
        {
        doKey(repair)
        randSleep()
        doKey(carpentryToolbelt["hammer"])
        doKey(improve)
        randSleep()
        randSleep(1000, 2000)
        }
        ...
        else if (findImpItem("whetstone"))
        {
        doKey(repair)
        randSleep()
        doKey(carpentryToolbelt["whetstone"])
        doKey(improve)
        randSleep()
        randSleep(1000, 2000)
        }
        else if (findImpItem("water"))
        {
        doKey(repair)
        randSleep()
        doKey(carpentryToolbelt["water"])
        doKey(improve)
        randSleep()
        randSleep(1000, 2000)
        }
