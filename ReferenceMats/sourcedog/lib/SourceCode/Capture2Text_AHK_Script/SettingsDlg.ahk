...
openSettingsDialog()
{
  ...
  Gui, Settings:Add, GroupBox, x20 y300 w430 h50, Text Direction
  dropDownitems := getFormattedDropdown("Auto|Horizontal|Vertical", TextDirection, Horizontal)
  Gui, Settings:Add, DropDownList, xp+10 yp+20 vOptTextDirection w100, %dropDownitems%
  Gui, Settings:Add, Text, xp+105 yp+2, (only used for Japanese and Chinese)

  Gui, Settings:Add, GroupBox, x20 y355 w430 h65, Whitelist
  ...
  Gui, Settings:Add, GroupBox, x20 y425 w430 h60, OCR Pre-Processing
