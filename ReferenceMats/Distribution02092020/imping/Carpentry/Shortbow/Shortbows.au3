#cs ==================================================================================================
	...
	S  H  O  R  T    B  O  W    I  M  P  E  R
	low level bowyery grind
	~ Dissimulo scripts

	--------------------------------------------------------------------------------------------------
	Created on 25/08/20
	Last Modified 25/08/20
	Version 0.1 (1 rare at least please)
	--------------------------------------------------------------------------------------------------
...
Func AnchorSet()
	Sleep(100)
	FindImage('shortbowicontext.bmp', 0, 0, 0, @DesktopWidth, @DesktopHeight, $anchorXY, 3)
	If $imagefound[3] == 1 Then
		...
		Next
	Else
		MsgBox(0, "Debug Msgbox", "shortbowicontext.bmp not found, exiting", 0, $handle) ;Debug
        Sleep(100)
        _Exit()
	EndIf
	FindImage('shortbowicontext.bmp', 1, 0, 0, @DesktopWidth, @DesktopHeight, $anchorXY, 3)
	If $imagefound[3] == 1 Then
		For $n = 0 to $actions - 1
