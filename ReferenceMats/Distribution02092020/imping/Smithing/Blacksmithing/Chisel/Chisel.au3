#cs ==================================================================================================
	...
	C  H  I  S  E  L    I  M  P  E  R
	make a rare goddamnit
	~ Dissimulo scripts

	--------------------------------------------------------------------------------------------------
	Created on 7/01/2016
	Last Modified 7/01/2016
...
Func AnchorSet()
	Sleep(100)
	FindImage('chiselicontext.bmp', 0, 0, 0, @DesktopWidth, @DesktopHeight, $anchorXY, 3)
	If $imagefound[3] == 1 Then
		...
		Next
	Else
		MsgBox(0, "Debug Msgbox", "chiselicontext.bmp not found, exiting", 0, $handle) ;Debug
        Sleep(100)
        _Exit()
	EndIf
	FindImage('chiselicontext.bmp', 1, 0, 0, @DesktopWidth, @DesktopHeight, $anchorXY, 3)
	If $imagefound[3] == 1 Then
		For $n = 0 to $actions - 1
