 #include <Misc.au3>
    ...
    Func MakeLock()
       ...
       If IsArray($line) Then
              ...
              Sleep(200)
              MouseMove($line[0]+200, $line[1]+40, 0)
              Sleep(200)
              MouseMove($line[0]+200, $line[1]+54, 0)
              Sleep(200)
              MouseMove($line[0]+330, $line[1]+54, 0)
              Sleep(200)
              MouseMove($line[0]+330, $line[1]+95, 0)
              Sleep(500)
              MouseClick("left")
       EndIf
    ...
    While (1)
       ...
       if $running==1 Then
		  ...
		  Local $random = Random(17000, 20000, 1)
		  Local $random2 = Random(10000, 11000, 1)
