    ...
    While (1)
	 ...
	 EndIf
       ...
       if $running==1 Then
		    ...
		    Local $hammer=1
			While $hammer=1
			$hammer = _ImageSearchArea("needle.bmp",1,$ulsearch[0],$ulsearch[1],$lrsearch[0],$lrsearch[1],$x1,$y1,50)
		   If $hammer=1 Then
			Hammer()
			Repair()
			checktimer()
			...
			Local $whetstone=1
			While $whetstone=1
			$whetstone = _ImageSearchArea("scissors.bmp",1,$ulsearch[0],$ulsearch[1],$lrsearch[0],$lrsearch[1],$x1,$y1,50)
		   If $whetstone=1 Then
			Whetstone()
			Repair()
			checktimer()
			...
			Local $pelt=1
			While $pelt=1
			$pelt = _ImageSearchArea("cloth.bmp",1,$ulsearch[0],$ulsearch[1],$lrsearch[0],$lrsearch[1],$x1,$y1,50)
		   If $pelt=1 Then
			Polish()
			Repair()
			checktimer()
