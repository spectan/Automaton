...
Global $shardwithdraw = "{5}" ;How many shafts to withdraw (based on mind logic/stamina restrictions)
...
#cs
Imagefound array [6]:
0 - rockshardicontextplusinv.bmp (rclick menu option start)
1 - createtext.bmp (rclick menu option 1)
2 - misctext.bmp (rclick menu option 2)
3 - stonebricktext.bmp (rclick menu option 3)
4 - rockshardsicontextbsb.bmp (shaft in BSB)
5 - stonebrickicontext.bmp (arrow shaft in inventory)
#ce
