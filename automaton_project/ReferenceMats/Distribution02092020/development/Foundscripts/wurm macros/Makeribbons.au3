 #include <Misc.au3>
    ...
    Func MakeLock()
       ...
       If IsArray($line) Then
              ...
              Sleep(200)
              MouseMove($line[0]+150, $line[1]+94, 0)
              Sleep(200)
              MouseMove($line[0]+300, $line[1]+94, 0)
              Sleep(200)
              MouseMove($line[0]+300, $line[1]+128, 50)
              Sleep(500)
              MouseClick("left")
       EndIf
    ...
    While (1)
       ...
       EndIf
       if $running==1 Then
		  Local $random = Random(35000, 40000, 1)
		  Local $random2 = Random(10000, 10500, 1)
