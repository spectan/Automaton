    ...
    While (1)
       if _IsPressed("01") And $setlockLoc==1 Then
		   ...
		   EndIf
		   			...
		   			if $timerr==1 Then
		   $length = InputBox("HOW LONG TO RUN", "How many minutes to run? *TOOLBELT ORDER* 1=ore, 2=whetstone, 3=hammer, 4=polish, 5=water *BIND* I Improve/Finish and R repair *Z to START*", 30)
