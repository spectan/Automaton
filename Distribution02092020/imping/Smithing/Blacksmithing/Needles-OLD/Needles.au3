#cs ==================================================================================================
	...
	N  E  E  D  L  E    I  M  P  E  R
	No iron, no problems
	~ Dissimulo scripts

	--------------------------------------------------------------------------------------------------
	Created on 2/08/2014
	Last Modified 2/08/2014
...
Func FindImage($bmpfilename, $centered, $fix1, $fiy1, $fix2, $fiy2, ByRef $foundv, $foundx)
    $imagefound[$foundx] = _ImageSearchArea($bmpfilename, $centered, $fix1, $fiy1, $fix2, $fiy2, $foundv[0], $foundv[1], 90)
...
Func AnchorSet()
	...
	If $imagefound[9] == 1 Then
			...
			$anchordamage[1] = $anchorXY[0] + 16 ;x2
	Else
	...
	If $imagefound[1] == 1 Then
			...
			$anchorimprove[1] = $anchorXY[0] + 25 ;x2
	Else
		...
		Case 1
			...
			If $stamina == 1 Then
				...
				If $smithingstopper = 0 Then
					...
					Resort(2)
					For $m = 0 To $actions - 1
						FindImage('hammericon.bmp', 1, $anchorimprove[0], $anchor[$m][1] + 16, $anchorimprove[1], $anchor[$m][1] + 16 + 14, $a, 4)
						Sleep(50)
						...
						Else
							FindImage('whetstoneicon.bmp', 1, $anchorimprove[0], $anchor[$m][1] + 16, $anchorimprove[1], $anchor[$m][1] + 16 + 14, $a, 5)
							If $imagefound[5] == 1 Then
								...
								Sleep(_Random_Gaussian(160, 30, 1))
							Else
								FindImage('pelticon.bmp', 1, $anchorimprove[0], $anchor[$m][1] + 16, $anchorimprove[1], $anchor[$m][1] + 16 + 14, $a, 6)
								If $imagefound[6] == 1 Then
									...
									Sleep(_Random_Gaussian(160, 30, 1))
								Else
									FindImage('pelticon.bmp', 1, $anchorimprove[0], $anchor[$m][1] + 16, $anchorimprove[1], $anchor[$m][1] + 16 + 14, $a, 7)
									If $imagefound[7] == 1 Then
										...
										Sleep(_Random_Gaussian(160, 30, 1))
									Else
										FindImage('malleticon.bmp', 1, $anchorimprove[0], $anchor[$m][1] + 16, $anchorimprove[1], $anchor[$m][1] + 16 + 14, $a, 8)
